...
<head>
    ...
    <title>PrimePage Bios: <?php echo (isset($t_title) ? $t_title : '$t_title defines the title') ?></title>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="basicExampleNav">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item"> <a class="nav-link" href="<?php echo $t_adjust_path;?>top20.php">Top 20</a></li>
...
if (file_exists("/var/www/html/TESTSITE")) {
    ...
    if (!empty($t_subtitle)) {
        echo '  <div class="alert alert-warning" role="alert">' . "\$t_subtitle is \"$t_subtitle\". How should we handle this on small screens?</div>\n";
    }
    if (!empty($t_add_menu)) {

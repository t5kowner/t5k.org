...
<header>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark <?php echo $mdbdrkcolor;?>">
    ...
    <div class="container">
      ...
      <!-- Navbar brand -->
      <a class="navbar-brand" href="/top20/">Top 20:</a>
      ...
      <div class="collapse navbar-collapse" id="basicExampleNav">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item"> <a class="nav-link" href="<?php echo $t_adjust_path;?>sizes.php">Sizes</a></li>
          <li class="nav-item"> <a class="nav-link" href="<?php echo $t_adjust_path;?>trends.php">Trends</a></li>
          <!-- Dropdown -->
  ...
  <div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb black p-1">
        ...
        <li class="breadcrumb-item"><a class="white-text" href="/top20/">Top 20</a></li>
...
<footer class="page-footer font-small <?php echo $mdbdrkcolor;?> pt-4 mt-4">
  ...
  <div class="footer-copyright text-center py-3"><!-- Library Item? "/Library/copyright.lbi" -->
    <a href="/primes/includes/copyright.php" class="none">Copyright &copy; <?php echo date("Y"); ?></a> &nbsp; <a href="https://t5k.org/">PrimePages</a>.&nbsp; (<a href="/notes/privacy.html">Privacy notice</a>)<!-- Library Item? --></div>
</footer>
<!-- Footer -->
